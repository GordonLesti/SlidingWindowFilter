...
Sakoe-Chiba band size is arbitrary and discussed in following paragraph on a smaller subset. The left top plot of figure
\ref{fig:result} illustrates the influence of the normalization. DTW combined with the $\eta$
...
36 \% in combination with the $\eta$ normalization and \textit{Mid} as window size determination. The right top plot of
figure \ref{fig:result} illustrates the distribution of the three approaches. The \textit{HAveD} and the
...
36 \% in combination with the $\eta$ normalization and \textit{HAveD} as threshold determination. The left bottom plot
of figure \ref{fig:result} illustrates the distribution of the four approaches. It is clearly visible that the
...
influence of the different filter approaches on the dominating configuration. The right bottom plot of figure
\ref{fig:result} illustrates the influence of the time series filter measures on the performance
