...
\begin{abstract} \addcontentsline{toc}{section}{Abstract}
    ...
    This bachelor thesis explains the approach of a filter with linear complexity for time series in front of a 1NN-DTW.
    The added value of a filter with cheap running time is to reduce the execution of a expensive
    1NN-DTW in the case of unclassifiable time series windows. On results of an experimental
    example with gesture detection via acceleration data will be shown that filters can reduce the execution of 1NN-DTW
