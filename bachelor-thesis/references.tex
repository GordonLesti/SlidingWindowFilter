\begin{thebibliography}{1} \addcontentsline{toc}{section}{References}
    ...
    \bibitem{sart2010accelerating} Sart, Doruk and Mueen, Abdullah and Najjar, Walid and Keogh, Eamonn and
    ...
    (2009): 657--675
    \bibitem{chan1983algorithms} Chan, Tony F and Golub, Gene H and LeVeque, Randall J "Algorithms for computing the
    sample variance: Analysis and recommendations" The American Statistician (1983): 242--247
    \bibitem{sokolova2009systematic} Sokolova, Marina and Lapalme, Guy "A systematic analysis of performance measures
    for classification tasks" Information Processing \& Management (2009): 427--437
    \bibitem{sakoe1978dynamic} Sakoe, Hiroaki and Chiba, Seibi "Dynamic programming algorithm optimization for spoken
    word recognition" IEEE transactions on acoustics, speech, and signal processing (1978): 43--49
    \bibitem{itakura1975minimum} Itakura, Fumitada "Minimum prediction residual principle applied to speech recognition"
    IEEE Transactions on Acoustics, Speech, and Signal Processing (1975): 67--72
    \bibitem{das1998rule} Das, Gautam and Lin, King-Ip and Mannila, Heikki and Renganathan, Gopal and Smyth, Padhraic
