...
series in front of the calculation \cite{ding2008querying}. In \cite{das1998rule} two different time series
normalizations are presented. Both time series normalizations $\eta$ and $\eta '$ will be explained in the following
section.
