...
\begin{figure}
                ...
                \begin{tabular}{ll}
                    ...
                    \begin{tikzpicture}
                        \begin{axis}[
                            ...
                            \addplot[white, ultra thick] table {../data/fig/dynamictimewarping/matrix_path.dat};
                        \end{axis}
                    \end{tikzpicture}
                \end{tabular}
            }
    ...
    shows the associated matrix containing the distances between the time series data points. Staring in the lower left
    corner and ending in the upper right corner, the warping path illustrated as white graph.}
