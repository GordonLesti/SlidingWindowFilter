            ...
            \resizebox {0.5\textwidth} {!} {
                \begin{tikzpicture}
                    \begin{axis}[
                        ...
                        ylabel=$Recall_{\mu}$,
                        samples=100]
                        \addplot[blue, only marks, mark size=0.4] table {../data/fig/window_size_result/ave.dat};
                        \addplot[red, only marks, mark size=0.4] table {../data/fig/window_size_result/max.dat};
                        \addplot[green, only marks, mark size=0.4] table {../data/fig/window_size_result/mid.dat};
                        \addplot[violet, only marks, mark size=0.4] table {../data/fig/window_size_result/min.dat};
