            ...
            \resizebox {0.5\textwidth} {!} {
                \begin{tikzpicture}
                    \begin{axis}[
                        ...
                        ylabel=$Recall_{\mu}$,
                        samples=100]
                        \addplot[blue, only marks, mark size=1] table {../data/fig/sliding_window_filter_result/lnce.dat};
                        \addlegendentry{LNCE}
                        \addplot[red, only marks, mark size=1] table {../data/fig/sliding_window_filter_result/var.dat};
                        \addlegendentry{VAR}
                        \addplot[green, only marks, mark size=1] table {../data/fig/sliding_window_filter_result/nofilter.dat};
            ...
            \resizebox {0.5\textwidth} {!} {
                \begin{tikzpicture}
                    \begin{axis}[
                        ...
                        ylabel=$Recall_{\mu}$,
                        samples=100]
                        \addplot[blue, only marks, mark size=0.4] table {../data/fig/sliding_window_filter_result/lnce.dat};
                        \addplot[red, only marks, mark size=0.4] table {../data/fig/sliding_window_filter_result/var.dat};
                        \addplot[green, only marks, mark size=0.4] table {../data/fig/sliding_window_filter_result/nofilter.dat};
