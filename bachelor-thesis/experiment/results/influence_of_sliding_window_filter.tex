            ...
            \resizebox {0.5\textwidth} {!} {
                \begin{tikzpicture}
                    \begin{axis}[
                        ...
                        \addlegendentry{VAR}
                        \addplot[green, mark=square, only marks, mark size=2] table {../data/fig/sliding_window_filter_result/nofilter.dat};
            ...
            \resizebox {0.5\textwidth} {!} {
                \begin{tikzpicture}
                    \begin{axis}[
                        ...
                        \addplot[green, mark=square, only marks, mark size=0.8] table {../data/fig/sliding_window_filter_result/nofilter.dat};
