            ...
            \resizebox {0.3\textwidth} {!} {
                \begin{tikzpicture}
                    \begin{axis}[
                        ...
                        \addplot[blue] table {../data/fig/blur_factor_result/ace.dat};
                        \addlegendentry{ACE}
            ...
            \resizebox {0.3\textwidth} {!} {
                \begin{tikzpicture}
                    \begin{axis}[
                        ...
                        width=\textwidth,
                        height=\axisdefaultheight]
                        \addplot[blue] table {../data/fig/blur_factor_result/ce.dat};
                        \addlegendentry{CE}
                        \addplot[red, domain=100:300] {0.736};
                        \addlegendentry{No Filter}
                    \end{axis}
            ...
            \resizebox {0.3\textwidth} {!} {
                \begin{tikzpicture}
                    \begin{axis}[
                        ...
                        width=\textwidth,
                        height=\axisdefaultheight]
                        \addplot[blue] table {../data/fig/nnc_calls_result/ace.dat};
                        \addlegendentry{ACE}
            ...
            \resizebox {0.3\textwidth} {!} {
                \begin{tikzpicture}
                    \begin{axis}[
                        ...
                        width=\textwidth,
                        height=\axisdefaultheight]
                        \addplot[blue] table {../data/fig/nnc_calls_result/ce.dat};
                        \addlegendentry{CE}
                        \addplot[red, domain=100:300] {4893};
                        \addlegendentry{No Filter}
                    \end{axis}
