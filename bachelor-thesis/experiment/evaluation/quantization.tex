            ...
            \resizebox {0.3\textwidth} {!} {
                \begin{tikzpicture}
                    \begin{axis}[
                        ...
                        \addplot[blue, ultra thick, mark=none] table[x=t, y=x] {experiment/evaluation/quantization/raw.dat};
                        \addplot[red, ultra thick, mark=none] table[x=t, y=y] {experiment/evaluation/quantization/raw.dat};
                        \addplot[green, ultra thick, mark=none] table[x=t, y=z] {experiment/evaluation/quantization/raw.dat};
                    \end{axis}
                \end{tikzpicture}
            } &
            \resizebox {0.3\textwidth} {!} {
                \begin{tikzpicture}
                    ...
                    \begin{axis}[
                        ...
                        ylabel=acceleration in $\frac{dm}{s^2}$,
                        legend columns=4]
                        \addplot[blue, ultra thick, mark=none] table[x=t, y=x] {experiment/evaluation/quantization/compressed.dat};
                        \addlegendentry{x-axis}
                        \addplot[red, ultra thick, mark=none] table[x=t, y=y] {experiment/evaluation/quantization/compressed.dat};
                        \addlegendentry{y-axis}
                        \addplot[green, ultra thick, mark=none] table[x=t, y=z] {experiment/evaluation/quantization/compressed.dat};
            ...
            \resizebox {0.3\textwidth} {!} {
                \begin{tikzpicture}
                    \begin{axis}[
                        ...
                        \addplot[blue, ultra thick, mark=none] table[x=t, y=x] {experiment/evaluation/quantization/converted.dat};
                        \addplot[red, ultra thick, mark=none] table[x=t, y=y] {experiment/evaluation/quantization/converted.dat};
                        \addplot[green, ultra thick, mark=none] table[x=t, y=z] {experiment/evaluation/quantization/converted.dat};
                    \end{axis}
                \end{tikzpicture}
            }
        \end{tabular}
