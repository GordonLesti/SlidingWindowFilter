            ...
            \resizebox {0.3\textwidth} {!} {
                \begin{tikzpicture}[spy using outlines={circle, magnification=6, connect spies}]
                    \begin{axis}[
                        ...
                        ylabel=$Recall_{\mu}$,
                        samples=100]
                        \addplot[blue, only marks, mark size=0.1] table {../data/fig/result/f1score.dat};
            ...
            \resizebox {0.3\textwidth} {!} {
                \begin{tikzpicture}[spy using outlines={circle, magnification=6, connect spies}]
                    \begin{axis}[
                        ...
                        ylabel=$Recall_{\mu}$,
                        samples=100]
                        \addplot[red, only marks, mark size=0.1] table {../data/fig/result/f0.5score.dat};
            ...
            \resizebox {0.3\textwidth} {!} {
                \begin{tikzpicture}[spy using outlines={circle, magnification=6, connect spies}]
                    \begin{axis}[
                        ...
                        ylabel=$Recall_{\mu}$,
                        samples=100]
                        \addplot[green, only marks, mark size=0.1] table {../data/fig/result/f2score.dat};
